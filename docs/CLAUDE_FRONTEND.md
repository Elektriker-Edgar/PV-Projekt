...
- **Keine Paketauswahl mehr in Schritt 2:** Das Formular fragt nur noch Leistung, Speicher und Wallbox-Konfiguration ab. Eventuelle Paketw�nsche werden sp�ter manuell erfasst.
- **Neue Breakdown-Felder:** Die Preisbox (Schritt 3) zeigt Geb�ude-, Netz-, WR-, Speicher-, Kabel- und Wallbox-Komponenten separat (reakdownBuilding, reakdownGrid, reakdownCable, reakdownWallboxBase �) plus Netto/MwSt./Brutto.
...
- **Zusammenfassung:** Die vorherige Paket-Badge entf�llt. Stattdessen werden nur noch technisch relevante Angaben angezeigt.
